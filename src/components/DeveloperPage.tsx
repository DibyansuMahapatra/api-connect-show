...
export function DeveloperPage() {
  return (
    <div className="relative min-h-full">
      ...
      <main className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 pb-20 pt-10 sm:pt-14">
        ...
        <section className="flex flex-col lg:flex-row items-center gap-10">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 scale-125 bg-primary/30 blur-3xl rounded-full opacity-60 animate-pulse" />

            {/* Secondary soft glow */}
            <div className="absolute inset-0 scale-110 bg-cyan-400/20 blur-2xl rounded-full opacity-40" />

                {/* Image container (NO BORDER, NO FRAME) */}
                <div className="relative h-full w-full overflow-hidden rounded-2xl">
                    <img
                    src="/PortfolioTBG.png"
                    alt="Developer"
                    className="h-full w-full object-cover scale-110 hover:scale-105 transition duration-700 ease-out"
                    />
                </div>
            ...
            {/* glow */}
            <div className="absolute inset-0 blur-2xl bg-primary/20 rounded-full -z-10" />
          </div>
        ...
        {/* PROJECT */}
        <section className="glass mt-6 rounded-2xl p-6 sm:p-8">
          <h2 className="text-xl sm:text-2xl font-semibold">Featured Project</h2>

          <p className="mt-4 text-sm sm:text-base text-muted-foreground leading-7">
            c-URL — A production-grade URL shortener built with Spring Boot,
            PostgreSQL, Redis caching, and Docker. Implements TTL-based expiration,
            click tracking, and high-performance redirect system.
          </p>
